...
while(codigo!=-1) :
    ...
    if(codigo not in cods and codigo!=-1):
        ...
        codigo=int(input("si desea agregar un nuevo codigo ingrese 1.."))
    if(codigo==1):
        codigo=input("ingrese nuevo codigo")
        cods.append(codigo)
        nuevoNombrePrecio=input("ingrese nombre,precio")
        nombresPrecios.append(nuevoNombrePrecio)
